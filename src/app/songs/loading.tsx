  ...
  return (
    <main className="min-h-screen bg-[#0d0d10] text-white">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 pb-24 md:px-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between border-b border-white/10 pb-6 mb-8">
          <div>
            <div className="h-9 w-48 rounded-lg bg-white/10 animate-pulse" />
            <div className="mt-2 h-4 w-96 rounded bg-white/[0.06] animate-pulse" />
          </div>
          <div className="flex gap-4">
            <div className="h-16 w-24 rounded-lg bg-[#18171c] border border-white/10 animate-pulse" />
            <div className="h-10 w-36 rounded-xl bg-violet-600/20 border border-violet-500/20 animate-pulse" />
          </div>
        </div>

        {/* Songs Grid Skeletons */}
