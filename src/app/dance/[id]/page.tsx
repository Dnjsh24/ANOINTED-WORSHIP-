        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {canManageDanceCharts && (
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-violet-600 px-4 py-2 text-xs font-bold text-white transition hover:bg-violet-500 active:scale-[0.98]"
            >
